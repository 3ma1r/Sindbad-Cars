<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vehicle4.aspx.cs" Inherits="Sindbad_Cars.Vehicle4" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="utf-8" />
    <title>Sindbad Cars • Toyota Corolla XSE</title>
    ...
    <style>
        ...
        /* BUY panel (centered rectangle, same sizing as Vehicle1/2) */
...
<form id="form1" runat="server">
    ...
    <header class="hero">
        <div class="container">
            <h1 class="fw-bold mb-1">Toyota Corolla XSE</h1>
            <p class="mb-0 text-white-50">Sporty styling • Tech-packed • Everyday efficiency</p>
        </div>
    </header>

    <!-- IMAGES (CAROUSEL) -->
    <section class="container my-4 vehicle-hero">
        <div id="xseCarousel" class="carousel slide cardx overflow-hidden">
            <div class="carousel-inner">
                <!-- If you have more images, add new carousel-item blocks and change src paths -->
                <div class="carousel-item active">
                    <img src="Corolla XSE/1.jpg" alt="Corolla XSE image 1" />
                </div>
                <div class="carousel-item">
                    <img src="Corolla XSE/2.jpg" alt="Corolla XSE image 2" />
                </div>
            </div>
            <button class="carousel-control-prev" type="button" data-bs-target="#xseCarousel" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#xseCarousel" data-bs-slide="next">
                ...
                <div class="cardx p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm align-middle mb-0">
                            <tbody>
                                <!-- Keep/adjust these values to match your current Vehicle4.aspx data -->
                                <tr><th scope="row" style="width:260px">Vehicle ID</th><td>D4010528</td></tr>
                                <tr><th scope="row">Exterior color</th><td>Black</td></tr>
                                <tr><th scope="row">Interior color</th><td>Black</td></tr>
                                <tr><th scope="row">Kilometers</th><td>35,000 - 45,000</td></tr>
                                <tr><th scope="row">Fuel Type</th><td>Regular unleaded</td></tr>
                                <tr><th scope="row">Engine displacement</th><td>1987 cc</td></tr>
                                <tr><th scope="row">Basic engine size</th><td>2.0 L</td></tr>
                                <tr><th scope="row">Number of cylinders</th><td>4</td></tr>
                                <tr><th scope="row">Drive type</th><td>Front wheel drive</td></tr>
                                <tr><th scope="row">Transmission type</th><td>Continuously variable-speed automatic (CVT)</td></tr>
                                <tr><th scope="row">Torque</th><td>~151 lb-ft @ 4,400 rpm</td></tr>
                ...
                <div class="right-stack">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm align-middle mb-0">
                                <tbody>
                                    ...
                                    <tr><th scope="row">Manufacture Warranty</th><td>valid till 10-02-2027</td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="cardx p-4 card-features">
                        ...
                        <ul class="list-unstyled list-check mb-0">
                            <li><i class="fa-solid fa-check text-success me-2"></i>Sporty exterior styling & unique XSE grille</li>
                            <li><i class="fa-solid fa-check text-success me-2"></i>SofTex / leather-trimmed seats with sport bolstering</li>
                            <li><i class="fa-solid fa-check text-success me-2"></i>Larger touchscreen with Apple CarPlay & Android Auto</li>
                            <li><i class="fa-solid fa-check text-success me-2"></i>Toyota Safety Sense (pre-collision, lane assist, ACC)</li>
                            <li><i class="fa-solid fa-check text-success me-2"></i>Dual-zone automatic A/C, Smart key with push start</li>
                            <li><i class="fa-solid fa-check text-success me-2"></i>Optional moonroof & premium audio</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="container my-4">
        <div class="cardx p-4 mx-auto text-center buy-panel">
            ...
            <div class="d-inline-flex align-items-center mb-3">
                ...
                <div class="price">OMR 6,900</div>
            </div>
            <div>
                <a href="Payment.aspx?item=Toyota%20Corolla%20XSE&price=6900"
                   class="btn btn-primary btn-lg">Buy</a>
            </div>
            <hr />
            <div class="small text-muted">
                <i class="fa-solid fa-shield-halved me-2 text-primary"></i>Warranty valid till 10-02-2027 &nbsp;•&nbsp;
