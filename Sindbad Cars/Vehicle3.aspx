...
<body>
 ...
 <li class="dropdown">
    ...
    <div class="slider">
        <div><img src="corolla XLE/3.jpg"></div>
        <div><img src="corolla XLE/2.jpg" alt="Image 2"></div>
    ...
    <table>
        ...
        <tr>
            <td class="pros">
                <ul>
                    <li>Safety: Toyota Safety Sense™ 2.0</li>
                    <li>Comfort: Power-adjustable seats, dual-zone climate control</li>
                    <li>Infotainment: Touchscreen, Apple CarPlay®/Android Auto™</li>
                    <li>Exterior: LED lights, alloy wheels</li>
                    <li>Interior: Premium materials, split-folding rear seats</li>
                    <li>Driver Assistance: Features like dynamic radar cruise control and automatic high beams</li>
                    <li>Luxury Touches: Leather-trimmed steering wheel and heated front seats</li>
                </ul>
            </td>
        </tr>
    </table>
    ...
    <table class="nav-justified">
        ...
        <tr>
            ...
            <td><span>126 lb-ft @ 3,900 rpm</span></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style2"><b><span>Fuel &amp; MPG</span></b></td>
            <td><span>Regular unleaded</span></td>
        </tr>
        <tr>
